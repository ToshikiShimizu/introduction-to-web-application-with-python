        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    # get Content-Type for header generation, get extension from path
                    if "." in path:
                        ext = path.rsplit(".", maxsplit=1)[-1]
                    else:
                        ext = ""
                    # get MIME Type from extension, octet-stream for unknown and unsupported extension
                ...
                # If an exception occurs during request processing, an error log will be output to the console and processing will continue.
                except Exception:
